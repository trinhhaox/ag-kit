...
model: inherit
skills: clean-code, dispatching-parallel-agents, behavioral-modes, writing-plans, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux, parallel-conductor, subagent-driven-development, executing-plans
---
